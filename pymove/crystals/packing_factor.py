...
from pymove.crystals.supercell import SupercellSphere
...
class PackingFactor(BaseDriver_):
    ...
    def calc_struct(self, struct):
        ...
        if self.low_memory == False:
            ...
            ele = self.unit_cell_struct.geometry["element"]
        ...
        self.struct.properties["Packing_Factor"] = packing_factor
...
#        struct.set_lattice_vectors(self.struct.get_lattice_vectors())
#        pstruct =  struct.get_pymatgen_structure()
#        test_frac = pstruct.frac_coords
#        print(np.sum(np.abs(frac-test_frac)))
...
#        pstruct =  self.struct.get_pymatgen_structure()
#        test_frac = pstruct.frac_coords
#        
#        print(frac)
#        print(np.sum(np.abs(frac - test_frac)))
...
if __name__ == "__main__":
    ...
    # teststream = SDS("/Users/ibier/Research/Volume_Estimation/Conquest/Searches/20200917_Newest_Entire_Workflow/3_Ambient_Pressure")
    
    # test_struct = preprocess(teststream["COYBOI02"],
    #                          bonds_kw={"mult":1.10, "skin":0.0, "update":True},
    #                          residues=0)
    
    # for value in [0.3]:
    #     # pf = PackingFactor(spacing=value, supercell_mult=1)
    #     # pf_original = pf.calc_struct(test_struct)
        
    #     pf = PackingFactor(spacing=value, supercell_mult=1, low_memory=True)
    #     pf_low = pf.calc_struct(test_struct)
...
#    from pymove.crystals import preprocess
#    
#    s = read("/Users/ibier/Research/Volume_Estimation/Conquest/Searches/20200317_Datasets_for_Alfred/struct_cif/NACCRE01.cif")
#    s = read("/Users/ibier/Research/Interfaces/Surface_Contour/20200606_Roughness_Results/RDX/CTMTNA15.cif")
#    s = read("/Users/ibier/Research/Volume_Estimation/Conquest/Searches/20200317_Datasets_for_Alfred/struct_cif/XACTAW.cif")
#    s = read("/Users/ibier/Research/Volume_Estimation/Models/20200622_Packing_Factor/Separate_Systems_Polymorph/Organometallic/NUHRUD.json")
#    s = read("/Users/ibier/Research/Volume_Estimation/Models/20200622_Packing_Factor/Separate_Systems_Polymorph/CHNO/CINMAC06.json")
#    
#    write("/Users/ibier/Research/Volume_Estimation/Models/20200530_Volume_Adapted_Radius/original.in", s, "geo", overwrite=True)
#    
#    s = preprocess(s)
#    
#    #    write("/Users/ibier/Research/Volume_Estimation/Models/20200530_Volume_Adapted_Radius/preprocess.in", s, "geo", overwrite=True)
#    
#    pf = PackingFactor(spacing=2)
#    print(pf.calc_struct(s))
#    
##    write("/Users/ibier/Research/Volume_Estimation/Models/20200530_Volume_Adapted_Radius/test.in", s, "geo", overwrite=True)
##    
#    write("/Users/ibier/Research/Volume_Estimation/Models/20200530_Volume_Adapted_Radius/unit.in", pf.unit_cell_struct, "geo", overwrite=True)
#    
#    
#    for idx,loc in enumerate(pf.grid_cart):
#        
#        if idx in pf.occupied_idx:
#            pf.unit_cell_struct.append(loc[0], loc[1], loc[2],
#                                       "Cl")
#        else:
#            pf.unit_cell_struct.append(loc[0], loc[1], loc[2],
#                                       "He")
#        
#    write("/Users/ibier/Research/Volume_Estimation/Models/20200530_Volume_Adapted_Radius/unit_grid.in", pf.unit_cell_struct, "geo", overwrite=True)
#    write("/Users/ibier/Research/Volume_Estimation/Models/20200530_Volume_Adapted_Radius/supercell.in", pf.supercell_struct, "geo", overwrite=True)
##        
